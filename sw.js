const CACHE='my-performance-v1.2.0';
const ASSETS=['./','./index.html','./styles.css','./planner.css','./routine.css','./data.js','./routine-data.js','./app.js','./cloud-sync.js','./planner.js','./routine.js','./notifications.js','./manifest.webmanifest','./icon.svg'];
