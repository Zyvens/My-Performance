...
for(const t of ["windowIds:['mon-lunch','tue-lunch','wed-lunch','thu-lunch','fri-lunch','sat-lunch']","windowIds:['mon-personal','tue-personal','wed-personal','thu-personal']","weekdays:[1,2,3,4,5,6]","windowIds:['mon-health','tue-training','wed-training','thu-health','fri-health','sat-health']"])assert(routine.includes(t),`meal/training routing missing ${t}`);
