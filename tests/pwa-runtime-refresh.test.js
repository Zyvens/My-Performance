...
assert.strictEqual(version.version,'1.5.20');
assert(index.includes('data-build="1.5.20"'));
...
assert(sw.includes("const BUILD='1.5.20'"),'service worker build must be 1.5.20');
