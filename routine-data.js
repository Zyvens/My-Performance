...
(function(){
  ...
  patch('personal-gym',{timeStart:'06:30',timeEnd:'08:00',durationMin:90,weekdays:[1,2,4,6],priority:95,tags:['treino','manhã','início até 07:00']});
  patch('personal-breakfast',{timeStart:'08:20',timeEnd:'08:45',durationMin:25,fixedTime:true,essential:true,priority:95});
  ...
  patch('career-pipeline',{timeStart:'16:45',timeEnd:'17:15',durationMin:30});
